...
namespace StudentExercises4.Data
{
    public class Repository
    {
        ...
        { get
            {
                string_connectionString = "Server=DESKTOP-8A7CVJI\\SQLEXPRESS;Database=StudentExercisesDB;Trusted_Connection=True;Initial Catalog=StudentExercises4;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
