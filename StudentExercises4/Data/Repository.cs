...
namespace StudentExercises4.Data
{
    public class Repository
    {
        ...
        { get
            {
                string _connectionString = "Server=Localhost\\SQLEXPRESS;Initial Catalog=StudentExercisesDB;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
            ...
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        Exercise exercise = new Exercise(Name: NameValue, Language: LanguageValue)
                        { Id = idValue };
        ...
        public List<Exercise> GetAllExercisesByLanguage(string language)
        {
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    List<Exercise> targetedExercises = new List<Exercise>();
                    while (reader.Read())
                    {
                        int idColumnPosition = reader.GetOrdinal("Id");
                        ...
                        targetedExercises.Add(exercise);
                    }
        ...
        public void AddExerciseToStudent(Student student, Exercise exercise)
        {
            ...
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    cmd.CommandText = $"INSERT INTO AssignedExercise (StudentId, ExerciseId) Values (@studentId, @exerciseId)";
